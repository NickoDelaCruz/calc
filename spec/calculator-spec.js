...
describe('Calculator', function() {
  ...
  it('Takes users age and converts it into seconds', function() {
    let Age = new Calculator(1, "1 year");
    expect(Age.age2Seconds()).toBeCloseTo(31536000)
  });

  it('Takes age and converts it into Mercury Age', function() {
    let Age = new Calculator(21, "11-21-1996");
    expect(Age.age2Mercury()).toBeCloseTo(87);
  });

  it('Takes age and converts it into Venus Age', function() {
    let Age = new Calculator(21, "11-21-1996");
    expect(Age.age2Venus()).toBeCloseTo(33);
  });

  it('Takes age and converts it into Mars Age', function() {
    let Age = new Calculator(21, "11-21-1996");
    expect(Age.age2Mars()).toBeCloseTo(11);
  });

  it('Takes age and converts it into Jupiter Age', function() {
    let Age = new Calculator(55, "11-21-1963");
    expect(Age.age2Jupiter()).toBeCloseTo(4);
  });
    it('Takes users age and calculates a life expectancy on earth', function() {
